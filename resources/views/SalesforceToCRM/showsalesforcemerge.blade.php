  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-body">
        ...
        <div class="row form-group">
          ...
          <div class="col-sm-2">
            <input type="text" class="form-control" name="title_nameC" value="{{$RowData->title_nameC}}" id="title_nameC" disabled>
          </div>
    ...
    <div class="row form-group">
      <div class="col-sm-12" align='center'>
        <button type="button" class="btn btn-flat btn-info btn-sm" name="button" Onclick="MergeToCrm();">Merge CRM</button>
      </div>
    </div>
  </div>
</div>
