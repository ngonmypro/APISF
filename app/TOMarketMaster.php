...
class TOMarketMaster extends Model
{
  protected $connection = 'sqlsrv';
  protected $table = 'TOMarketMaster';
  protected $primaryKey = 'TOMarketMaster.TOMarketId';

  public function SelectTOMarketMaster()
  {
    ...
    $sql = DB::connection('sqlsrv')->select("SELECT TOMarketId, TOMarketData FROM TOMarketMaster $where ORDER BY TOMarketData ASC");
    //dd($sql);
      return $sql;
  }
}
